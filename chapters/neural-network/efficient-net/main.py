...
from keras.api.applications.efficientnet_v2 import EfficientNetV2B3, preprocess_input
...
IMG_SIZE = 300  # EfficientNetV2B3の入力サイズ
BATCH_SIZE = 32
...
model.save("models/food101_efficientnetv2b3_finetuned_final.keras")
...
def plot_fine_tune_history(original_history, fine_tune_history):
    ...
    plt.savefig("images/learning_curve_finetunedV2b3_final.png")
...
plt.tight_layout()
plt.savefig("images/prediction_resultsB3.png")
